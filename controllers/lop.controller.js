...
module.exports.getLop= async(req, res)=>{
...
module.exports.getLopByID= async (req, res)=>{
...
module.exports.createLop = async(req, res)=>{
  let body = req.body;
...
module.exports.updateLop= async(req, res)=>{
